...
float speedbrakeinc = -0.3;//decrease in speed before brake light turns on
int leftturn1 = 0;
int leftturn2 = 1;
int leftturn3 = 2;
int rightturn3 = 2;
...
void leftblinker(){
  Serial.print("Animationcountleft: ");
  Serial.println(animationcountleft);
  if (animationcountleft == 1){
    if ((millis() - startmillis) < 220){
...
void rightblinker(){
  Serial.print("Animationcountright: ");
  Serial.println(animationcountright);
...
void brakelight(int brakelighton){
  if (brakelighton == 1){
    ...
    pixels.setPixelColor(brake1, pixels.Color(75, 0, 0));//dim brake light
    pixels.setPixelColor(brake2, pixels.Color(75, 0, 0));//dim brake light
    pixels.setPixelColor(brake3, pixels.Color(75, 0, 0));//dim brake light
    pixels.setPixelColor(brake4, pixels.Color(75, 0, 0));//dim brake light
    pixels.setPixelColor(brake5, pixels.Color(75, 0, 0));//dim brake light
    pixels.show();
  }
  else {
